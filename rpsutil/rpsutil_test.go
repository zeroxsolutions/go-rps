...
func TestBuild_Success(t *testing.T) {
	...
	config, err := rpsutil.Build[Config](mockLister)
	if err != nil {
...
func TestBuild_NilOption(t *testing.T) {
	...
	config, err := rpsutil.Build[Config](nil)
	if err != nil {
		t.Fatalf("Expected no error, got %v", err)
	}
...
func TestBuild_MultipleOptions(t *testing.T) {
	...
	config, err := rpsutil.Build[Config](mockLister1, mockLister2)
	if err != nil {
		t.Fatalf("Expected no error, got %v", err)
	}
...
func TestBuild_EmptyOptions(t *testing.T) {
	...
	config, err := rpsutil.Build[Config]()
	if err != nil {
		t.Fatalf("Expected no error, got %v", err)
	}
